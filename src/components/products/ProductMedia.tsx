...
import { Input } from "@/components/ui/input.jsx"; // Import Input for video link

interface ProductMediaProps {
  imageUrl: string;
  setImageUrl: (url: string) => void;
  hoverImageUrl: string;
  setHoverImageUrl: (url: string) => void;
  videoUrl: string;
  setVideoUrl: (url: string) => void;
}

const ProductMedia = ({ imageUrl, setImageUrl, hoverImageUrl, setHoverImageUrl, videoUrl, setVideoUrl }: ProductMediaProps) => {
  const handleAddImage = (type: 'main' | 'hover') => {
