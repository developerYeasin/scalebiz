...
interface CategoryListPaginationProps {
  currentPage: number;
  totalPages: number;
...
const CategoryListPagination = ({ currentPage, totalPages, onPageChange, itemsPerPage, onItemsPerPageChange, totalItems }: CategoryListPaginationProps) => {
