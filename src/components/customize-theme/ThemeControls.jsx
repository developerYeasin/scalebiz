          ...
          <div>
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={cn(
                  "flex-1",
                  config.theme_mode === "Light" && "bg-primary text-primary-foreground hover:bg-primary/90"
                )}
                onClick={() => updateNested('theme_mode', "Light")}
                disabled={isUpdating}
              >
                Light {config.theme_mode === "Light" && <Check className="h-4 w-4 ml-2" />}
              </Button>
              <Button
                variant="outline"
                className={cn(
                  "flex-1",
                  config.theme_mode === "Dark" && "bg-primary text-primary-foreground hover:bg-primary/90"
                )}
                onClick={() => updateNested('theme_mode', "Dark")}
                disabled={isUpdating}
              >
                Dark {config.theme_mode === "Dark" && <Check className="h-4 w-4 ml-2" />}
              </Button>
            </div>
          </div>
