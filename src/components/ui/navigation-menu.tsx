...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[animate=in]:animate-in data-[animate=out]:animate-out data-[animate=in]:fade-in data-[animate=out]:fade-out data-[animate=in]:zoom-in-90 data-[animate=out]:zoom-out-90 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 md:absolute md:w-auto ",
      className
    )}
    {...props}
  />
