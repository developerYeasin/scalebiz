...
const CreatePromoCodeDialog: React.FC<CreatePromoCodeDialogProps> = ({ isOpen, onClose }) => {
  const [expiryDate, setExpiryDate] = React.useState<Date>();
  const [discountType, setDiscountType] = React.useState<"amount" | "percentage">("amount");
