...
import {
  ...
  DialogHeader,
  DialogTitle,
} from "@/components/ui/dialog.tsx"; // Updated import to .tsx
...
const CreatePromoCodeDialog = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] h-[90vh] max-h-[90vh] flex flex-col overflow-hidden"> {/* Added height and flex classes */}
